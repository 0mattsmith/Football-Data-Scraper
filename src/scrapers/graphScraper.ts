import { FootballKnowledgeGraph, ClubProfile, StadiumProfile, TrophyProfile, NationalTeamProfile, ManagerProfile } from '../types/graph';
...
const SEED_CLUBS: Record<string, ClubProfile> = {
  'arsenal': {
    id: 'arsenal',
    name: 'Arsenal F.C.',
    shortName: 'Arsenal',
...
const SEED_STADIUMS: Record<string, StadiumProfile> = {
  'highbury': {
    id: 'highbury',
...
const SEED_TROPHIES: Record<string, TrophyProfile> = {
  'fa-cup': {
    id: 'fa-cup',
    name: 'The FA Cup',
    shortName: 'FA Cup',
...
const SEED_NATIONAL_TEAMS: Record<string, NationalTeamProfile> = {
  'england': {
    id: 'england',
...
const SEED_MANAGERS: Record<string, ManagerProfile> = {
  'arsene-wenger': {
    id: 'arsene-wenger',
    name: 'Arsène Wenger',
...
export function buildFootballKnowledgeGraph(): FootballKnowledgeGraph {
  return {
    clubs: SEED_CLUBS,
